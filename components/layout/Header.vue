...
<header class="bg-white pb-3">
    <div class="container mx-auto px-6 py-3">
        <div class="flex items-center justify-between">
            <div class=" w-full text-gray-600 md:flex md:items-center">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
        ...
        <nav  class="sm:flex sm:justify-center sm:items-center mt-4">
            ...
            <a class="mt-3 text-gray-600 hover:text-primary sm:mx-3 sm:mt-0" href="#">Home</a>
          <a class="mt-3 text-gray-600 hover:text-primary sm:mx-3 sm:mt-0" href="#">Cart</a>
          <a class="mt-3 text-gray-600 hover:text-primary sm:mx-3 sm:mt-0" href="#">About</a>
            </div>
        </nav>
